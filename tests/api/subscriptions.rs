...
async fn subscribe_returns_a_400_when_data_is_missing() {
    ...
    let app = spawn_app().await;
    let test_cases = vec![
        ("name=FirstName%20LastName", "missing the email"),
        ("email=mynickname%40gmail.com", "missing the name"),
...
async fn subscribe_returns_a_400_when_fields_are_present_but_invalid() {
    ...
    let app = spawn_app().await;
    let test_cases = vec![
        ("name=&email=mynickname%40gmail.com", "empty name"),
        ("name=FirstName%20LastName&email=", "empty email"),
        (
            "name=FirstName%20LastName&email=definitely-not-an-email",
            "invalid email",
        ),
    ];
